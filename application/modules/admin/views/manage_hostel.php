      ...
      <div class="row">
       ...
       <?php echo validation_errors("<div class='callout callout-danger'>","</div>"); ?>
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?= base_url()?>index.php/admin/Manage_hostel?id=<?= $id ?>" method="post">
              <div class="box-body">
              ...
              <div class="form-group">
                  <label for="exampleInputEmail1">Hostel Email</label>
                  <input type="email" class="form-control"  name="email" value="<?= $email ?>" placeholder="Enter Hostel Email">
                </div> 
                <div class="form-group">
                  <label for="exampleInputEmail1">Password</label>
                  <input type="text" class="form-control" value="<?= $password ?>" name="password" placeholder="Enter Password">
              </div>  
