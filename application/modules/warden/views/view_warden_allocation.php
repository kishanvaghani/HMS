              ...
              <div class="box-body table-responsive">
               ...
               ?>
                ...
                <td><?php echo $row->warden_id ?></td>
                      ...
                      <td>
                         <a class="btn btn-primary btn-xs" href="<?= base_url()?>index.php/admin/warden_allocation/update_allocation/<?= $row->id ?>">Update</a>
                        <a class="btn btn-danger btn-xs" href="<?= base_url()?>index.php/admin/warden_allocation/delete_allocation?id=<?= $row->id ?>">Delete</a>
