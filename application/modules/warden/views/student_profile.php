        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              {
              ?>
              <a href="<?= base_url() ?>index.php/warden/view_student/reject?sid=<?= $row->id ?>" class="btn btn-danger btn-block"><b>Reject</b></a>
            <?php }else{

              ?>
               <a href="<?= base_url() ?>index.php/warden/view_student/verify?sid=<?= $row->id ?>" class="btn btn-primary btn-block"><b>Verify</b></a>
             <?php } ?>
            </div>
            <!-- /.box-body -->
          </div>
